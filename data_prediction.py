...
# Randomized search over RF hyperparams with GroupKFold (one split per city)
param_dist = {
...
# Per-city detailed diagnostics (model has seen every city in training)
